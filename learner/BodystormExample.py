...
class Example(QDialog):
	...
	def __init__(self, bodystorm_history, demo, update_model_callback):
	...
	def setup_output_parameters(self, demo_output):
		...
		for output in Alphabet.get_outputs():
		...
		for gesture in Gesture.get_gestures():
	...
	def setup_input_parameters(self, demo_input):
		...
		for inp in Alphabet.get_inputs():
