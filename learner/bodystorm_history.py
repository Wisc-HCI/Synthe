...
class BodystormHistory(QGroupBox):
	...
	def __init__(self, name, parent, frame):
		...
		self.headers = QLabel("on/off      demonstration information", self)
	...
	def expand_example(self, item):
		self.userDialog = Example(self, item.data(Qt.UserRole).demo_array, self.frame.update_model, self.Alphabet)
