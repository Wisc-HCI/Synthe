...
class Bodystorm():
	...
	def __init__(self, alphabet_path):
		...
		# UNCOMMENT
		self.populate_sigma_omega(alphabet_path)

		# process the name of the design
		self.design = alphabet_path
		self.design = self.design[10:self.design.index(".alphabet")]

	def populate_sigma_omega(self, alphabet_path):
		# import alphabet
		alphabet_file = importlib.import_module(alphabet_path)
		Alphabet = alphabet_file.Alphabet
		Gaze = alphabet_file.Gaze
		Gesture = alphabet_file.Gesture
		...
		self.GESTURE = Alphabet.get_gestures()
